...
public class LotteryTicket {
    ...
    public static int[] generateNumber(){
        ...
        for(int i=0; i<LENGTH; i++ ){
            ...
            //Generate random number then search it make sure it doesn't already exist in the array.If it does, regenerate and search again.
            do{
     ...
     * @param numberToSerachFor Value to search for
